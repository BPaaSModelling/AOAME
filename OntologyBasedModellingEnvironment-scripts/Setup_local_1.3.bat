...
rem clone and deploy WholeApp
set git_name=Ontology4ModelingEnvironment-WholeApp
set git_repository=https://github.com/BPaaSModelling/Ontology4ModelingEnvironment-WholeApp.git
set branch=%webapp_branch%

call :clone_repository


rem variable for npm and ng build
...
if not exist %git_name% (
	...
	call git clone --recurse-submodules %git_repository%
